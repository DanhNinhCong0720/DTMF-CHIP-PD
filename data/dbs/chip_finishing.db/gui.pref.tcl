...
set_preference attribute_summary_route_blockage "density design_rule_width inst is_except_pg_net is_no_wrong_way is_only_pg_net is_pushdown layer name obj_type rects shapes spacing type"
...
set_preference attribute_summary_group "area constraint_type density exclusive_group_gap exclusive_group_type exclusive_groups is_floating members name obj_type parent power_domain rects safety_dcls_isolate_clock safety_failure_mode safety_mechanism safety_mechanism_type"
...
set_preference attribute_summary_bump "base_cell base_name bbox bump_connect_target bump_pins center escaped_name is_fixed_assignment location name net obj_type orient place_status ports"
...
set_preference attribute_summary_tech "base_cells base_pins layers lef_files name obj_type pg_base_pins route_rule sites stack_via_rules via_def_rules via_defs"
...
set_preference attribute_summary_hinst "area base_name bbox boundary dft_dont_scan dont_touch dont_touch_effective dont_touch_hports dont_touch_sources dont_use_cells dont_use_cells_effective escaped_name group hinsts hnets hpins hports ilm_inst insts is_ilm local_hinsts local_hnets local_hpins local_insts local_pins module name obj_type orient parent partition power_domain power_dynamic power_internal power_leakage power_switching power_toggle_rate power_total read_only read_only_effective ungroup_allowed use_cells"
